// ======================================================================
// MATRIX.v generated from TopDesign.cysch
// 09/29/2021 at 20:34
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ae727336-9e98-4b20-ab47-4a2cdef30940/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [3:0] tmpOE__FILAS_net;
	wire [3:0] tmpFB_3__FILAS_net;
	wire [3:0] tmpIO_3__FILAS_net;
	electrical [0:0] tmpSIOVREF__FILAS_net;
	...
	cy_psoc3_pins_v1_10
		...
		FILAS
		 (.oe(tmpOE__FILAS_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__FILAS_net[3:0]}),
		  .io({tmpIO_3__FILAS_net[3:0]}),
		  .siovref(tmpSIOVREF__FILAS_net),
		  .interrupt({Net_3}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__FILAS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
	...
	wire [3:0] tmpOE__COLUMNAS_net;
	wire [3:0] tmpFB_3__COLUMNAS_net;
	wire [3:0] tmpIO_3__COLUMNAS_net;
	wire [0:0] tmpINTERRUPT_0__COLUMNAS_net;
	electrical [0:0] tmpSIOVREF__COLUMNAS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(8'b00_00_00_00))
		COLUMNAS
		 (.oe(tmpOE__COLUMNAS_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__COLUMNAS_net[3:0]}),
		  .io({tmpIO_3__COLUMNAS_net[3:0]}),
		  .siovref(tmpSIOVREF__COLUMNAS_net),
		  .interrupt({tmpINTERRUPT_0__COLUMNAS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__COLUMNAS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
	...
	wire [0:0] tmpOE__Alarm_net;
	wire [0:0] tmpFB_0__Alarm_net;
	wire [0:0] tmpIO_0__Alarm_net;
	wire [0:0] tmpINTERRUPT_0__Alarm_net;
	electrical [0:0] tmpSIOVREF__Alarm_net;

	cy_psoc3_pins_v1_10
		#(.id("9015fe65-9e94-4ae5-a5a1-f6b14de38077"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Alarm
		 (.oe(tmpOE__Alarm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Alarm_net[0:0]}),
		  .io({tmpIO_0__Alarm_net[0:0]}),
		  .siovref(tmpSIOVREF__Alarm_net),
		  .interrupt({tmpINTERRUPT_0__Alarm_net[0:0]}),
		  .annotation({Net_49}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Alarm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SENSOR_net;
	wire [0:0] tmpFB_0__SENSOR_net;
	wire [0:0] tmpIO_0__SENSOR_net;
	electrical [0:0] tmpSIOVREF__SENSOR_net;

	cy_psoc3_pins_v1_10
		#(.id("fc7a1581-a42e-4df5-ac12-c8fd52c32dac"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SENSOR
		 (.oe(tmpOE__SENSOR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SENSOR_net[0:0]}),
		  .io({tmpIO_0__SENSOR_net[0:0]}),
		  .siovref(tmpSIOVREF__SENSOR_net),
		  .interrupt({Net_45}),
		  .annotation({Net_29}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SENSOR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
