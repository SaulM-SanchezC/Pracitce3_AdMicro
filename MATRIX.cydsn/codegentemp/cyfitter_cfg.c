...
/* PICU_0 Address: CYDEV_PICU_INTTYPE_PICU0_BASE Size (bytes): 8 */
#define BS_PICU_0_VAL ((const uint8 CYFAR *)0x48000008u)

/* IOPINS0_0 Address: CYREG_PRT0_DR Size (bytes): 10 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000010u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000028u)
...
void cyfitter_cfg(void)
{
...

	{
		...
		static const cfg_memcpy_t CYCODE cfg_memcpy_list [] = {
			/* dest, src, size */
			{(void CYFAR *)(CYDEV_PICU_INTTYPE_PICU0_BASE), BS_PICU_0_VAL, 8u},
		};
